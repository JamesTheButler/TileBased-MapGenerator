...
public class TerrainTile : Tile {
    ...
    /// <summary>
    /// Refreshes this tile and other tiles that orthogonally and diagonally adjacent.
    /// </summary>
    ...
    /// <summary>
    /// Determines which sprite is used based on the RoadTiles that are adjacent to it and rotates it to fit the other tiles.
    ...
    /// <summary>
    /// Determines which rotation to use based on the positions of adjacent Tiles.
    /// </summary>
...
#if UNITY_EDITOR
    /// <summary>
    /// Adds a menu item to create a RoadTile Asset
    /// </summary>
